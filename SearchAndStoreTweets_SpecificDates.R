...
# start/end dates
date_start <- as.Date(ymd("2018-05-25"))  # this date is included
date_end <- as.Date(ymd("2018-05-28"))    # this date is not included
...
# search twitter!
search.str <- search.str <- paste0("eco-hydrology OR ecohydrology OR hydroecology OR hydro-ecology OR #hydroecology OR #ecohydrology OR #ecohydro OR (ecology and (hydrology OR hydrogeology)) since:", as.character(date_start), " until:", as.character(date_end))
